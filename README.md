...
In addition, a Flatpak/snap (or similar) package is planned for the future, alleviating the need to manually compile the project. If you don't want to compile the code, it might be better to use Windows for now or use Proton on the Steam Deck.
