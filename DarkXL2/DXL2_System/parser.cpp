...
DXL2_Parser::DXL2_Parser() : m_buffer(nullptr), m_bufferLen(0u), m_enableBlockComments(false), m_blockComment(false), m_enableColorSeperator(false) {}
DXL2_Parser::~DXL2_Parser() {}

void DXL2_Parser::init(const char* buffer, size_t len)
{
	m_buffer = buffer;
	m_bufferLen = len;
}
...
void DXL2_Parser::tokenizeLine(const char* line, TokenList& tokens)
{
	tokens.clear();
