...
namespace DXL2_ModelRender
{
	...
	void draw(const Model* model, const Vec3f* modelOrientation, const Vec3f* modelPos, const Vec3f* cameraPos, const f32* cameraRot, f32 heightOffset, const Sector* sector = nullptr);
