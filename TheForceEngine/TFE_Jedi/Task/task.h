...
typedef void(*LocalMemorySerCallback)(vpFile* stream, void* userData, void* mem);
...
namespace TFE_Jedi
{
	...
	void task_serializeState(vpFile* stream, Task* task, void* userData = nullptr, LocalMemorySerCallback localMemCallback = nullptr);
